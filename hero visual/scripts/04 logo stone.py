...
LETTER_TRACKING = 1.0
KERNING_BY_INDEX = {2: -0.16, 3: -0.24}    # V into the e, the i tucked under the V's right arm. Media spacing is left alone.   # pull these letters toward the one before them, in em
